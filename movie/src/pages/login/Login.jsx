...
const Login = () => {
    ...
    } else if (alert === 'Bạn đã đăng nhập!') {
        navigate(-1)
    }
                ...
                <div className="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
                    ...
                    >
                        <div className="flex items-center text-lg mb-6 md:mb-8">
                            ...
                            <input type="text" id="username" className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Tài Khoản"  {...register('taiKhoan')} />
                        </div>
                        <div className="flex items-center text-lg mb-6 md:mb-8">
